 ...
 *
 * Les deux comptent, pour deux raisons distinctes : la page en ligne casse à
...
function dependentInPage(page: Page | null | undefined, module: ModuleId): BlockType[] {
  ...
  return [
    ...new Set([
      ...dependentBlocks(page.layout_json, module),
      ...dependentBlocks(effectiveLayout(page), module),
    ]),
  ]
}
...
export function DashboardModules() {
  ...
  const pendingBlocks =
    pending ? dependentInPage(page, pending) : []
